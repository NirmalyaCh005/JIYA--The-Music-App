...
export function Sidebar() {
  ...
  const curatedPlaylists = [
    { name: 'Late Night Lofi', count: '24 tracks', href: '/explore' },
    { name: 'Cyberpunk Essentials', count: '18 tracks', href: '/explore' },
    { name: 'Bollywood Romance', count: '32 tracks', href: '/explore' },
    { name: 'Gym Workout Hype', count: '15 tracks', href: '/explore' },
    { name: 'Chill Study Beats', count: '40 tracks', href: '/explore' },
    { name: 'Viral Punjabi Bass', count: '28 tracks', href: '/explore' },
  ];
        ...
        <div className="space-y-1 pt-1">
          ...
          <div className="space-y-0.5 max-h-60 overflow-y-auto custom-scrollbar">
            ...
            {curatedPlaylists.map((pl) => (
              ...
              >
                <div className="flex items-center gap-2.5 min-w-0">
                  <Music2 className="w-3.5 h-3.5 text-slate-400 group-hover:text-blue-500 shrink-0" />
